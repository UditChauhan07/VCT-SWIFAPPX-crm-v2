...
function LoadRoleForm({ isUpdateForm = false }) {
  ...
  let entities = ['people', 'api_access', 'company', 'lead', 'client', 'clientaddress', 'offer', 'invoice', 'quote', 'payment', 'product', 'productcategory', 'expense', 'expensecategory', 'admin', 'roles', 'paymentMode', 'taxes', 'pricingmodel', 'subscriptiontype', 'servicecategory', 'servicelist', 'publicholiday', 'worker']
