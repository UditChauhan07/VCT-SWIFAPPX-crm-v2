...
export default function ReadItem({ config, selectedItem }) {
  ...
  return (
    <>
      ...
      <h2 style={{ marginTop: '4%' }}>Basic Contract Details</h2>
      <Row className="gutter-row">
        <Col span={24}>
          <div
            className=""
            ...
            <Row className="gutter-row" style={{ padding: '0px 0px 0px 20px' }}>
              <Col span={12}>
                ...
                <Row className="gutter-row">
                  <Col span={12}>
                    <p style={{ fontSize: '15px', fontWeight: '600' }}>
                      {translate('Contract Status')} :<br></br>
                    </p>
                  </Col>
                  <Col span={12}>
                    <p
      ...
      <h2 style={{ marginTop: '4%' }}>Contract Billing Detail</h2>
